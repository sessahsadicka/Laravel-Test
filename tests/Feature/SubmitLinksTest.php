...
class SubmitLinksTest extends TestCase
{
    ...
    {
        $response = $this->post('laravel-test/public/submit', [
            'title' => 'Example Title',
    ...
    function max_length_succeeds_when_under_max()
    {
        ...
        $this->post('laravel-test/public/submit', $data);
    ...
    function max_length_fails_when_too_long()
    {
        ...
        try {
            $this->post('laravel-test/public/submit', compact('title', 'url', 'description'));
